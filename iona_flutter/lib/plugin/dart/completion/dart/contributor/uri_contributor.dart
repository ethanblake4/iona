...
class _UriSuggestionBuilder extends SimpleAstVisitor<void> {
  ...
  void _addPackageFolderSuggestions(String partial, String prefix, Folder folder) {
    try {
  ...
  String _extractPartialUri(SimpleStringLiteral node) {
    ...
    return node.literal.lexeme.substring(node.contentsOffset - node.offset, request.offset - node.offset);
  }
}
