...
import 'package:iona_flutter/plugin/dart/correction/name_suggestion.dart';
...
class VariableNameContributor extends DartCompletionContributor {
  ...
  Future<void> computeSuggestions(DartCompletionRequest request, SuggestionBuilder builder) async {
    ...
    if (opType.includeVarNameSuggestions) {
      ...
      var doIncludePrivateVersion = opType.inFieldDeclaration || opType.inTopLevelVariableDeclaration;
