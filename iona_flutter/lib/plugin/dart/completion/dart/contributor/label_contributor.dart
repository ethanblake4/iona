  ...
  Future<void> computeSuggestions(DartCompletionRequest request, SuggestionBuilder builder) async {
    ...
    if (!optype.isPrefixed) {
      if (optype.includeStatementLabelSuggestions || optype.includeCaseLabelSuggestions) {
        _LabelVisitor(request, builder, optype.includeStatementLabelSuggestions, optype.includeCaseLabelSuggestions)
...
class _LabelVisitor extends LocalDeclarationVisitor {
  ...
  _LabelVisitor(this.request, this.builder, this.includeStatementLabels, this.includeCaseLabels)
