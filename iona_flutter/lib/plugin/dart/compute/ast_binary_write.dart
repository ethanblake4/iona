...
//    );
  ...
  LinkedNodeBuilder visitConstructorDeclaration(ConstructorDeclaration node) {
    var builder = LinkedNodeBuilder.constructorDeclaration(
      ...
      constructorDeclaration_redirectedConstructor: node.redirectedConstructor?.accept(this),
  ...
  @override
  LinkedNodeBuilder visitConstructorFieldInitializer(ConstructorFieldInitializer node) {
  ...
  LinkedNodeBuilder visitExtensionOverride(ExtensionOverride node) {
    var builder = LinkedNodeBuilder.extensionOverride(
      ...
      extensionOverride_typeArgumentTypes: node.typeArgumentTypes.map(_writeType).toList(),
  ...
  @override
  LinkedNodeBuilder visitForEachPartsWithDeclaration(ForEachPartsWithDeclaration node) {
  ...
  @override
  LinkedNodeBuilder visitForEachPartsWithIdentifier(ForEachPartsWithIdentifier node) {
  ...
  LinkedNodeBuilder visitFormalParameterList(FormalParameterList node) {
    ...
    builder.flags = AstBinaryFlags.encode(
      isDelimiterCurly: node.leftDelimiter?.type == TokenType.OPEN_CURLY_BRACKET,
      isDelimiterSquare: node.leftDelimiter?.type == TokenType.OPEN_SQUARE_BRACKET,
    );
    return builder;
  }

  @override
  LinkedNodeBuilder visitForPartsWithDeclarations(ForPartsWithDeclarations node) {
  ...
  LinkedNodeBuilder visitFunctionDeclaration(FunctionDeclaration node) {
    var builder = LinkedNodeBuilder.functionDeclaration(
      ...
      functionDeclaration_functionExpression: node.functionExpression?.accept(this),
    );
    builder.flags = AstBinaryFlags.encode(
      isExternal: node.externalKeyword != null,
      isGet: node.isGetter,
  ...
  @override
  LinkedNodeBuilder visitFunctionDeclarationStatement(FunctionDeclarationStatement node) {
    return LinkedNodeBuilder.functionDeclarationStatement(
      functionDeclarationStatement_functionDeclaration: node.functionDeclaration.accept(this),
    );
  }
  ...
  @override
  LinkedNodeBuilder visitFunctionExpressionInvocation(FunctionExpressionInvocation node) {
  ...
  LinkedNodeBuilder visitFunctionTypeAlias(FunctionTypeAlias node) {
    ...
    try {
      var builder = LinkedNodeBuilder.functionTypeAlias(
        ...
        typeAlias_hasSelfReference: LazyFunctionTypeAlias.getHasSelfReference(node),
      );
      _storeTypeAlias(builder, node);
      _writeActualReturnType(builder, node);
      _storeIsSimpleBounded(builder, node);
  ...
  @override
  LinkedNodeBuilder visitFunctionTypedFormalParameter(FunctionTypedFormalParameter node) {
    var builder = LinkedNodeBuilder.functionTypedFormalParameter(
      functionTypedFormalParameter_formalParameters: node.parameters.accept(this),
      functionTypedFormalParameter_returnType: node.returnType?.accept(this),
      functionTypedFormalParameter_typeParameters: node.typeParameters?.accept(this),
    );
  ...
  LinkedNodeBuilder visitGenericTypeAlias(GenericTypeAlias node) {
    ...
    try {
      var builder = LinkedNodeBuilder.genericTypeAlias(
        ...
        typeAlias_hasSelfReference: LazyGenericTypeAlias.getHasSelfReference(node),
      );
      _storeTypeAlias(builder, node);
      _storeIsSimpleBounded(builder, node);
      return builder;
  ...
  @override
  LinkedNodeBuilder visitInstanceCreationExpression(InstanceCreationExpression node) {
    ...
    var builder = LinkedNodeBuilder.instanceCreationExpression(
      ...
      instanceCreationExpression_constructorName: node.constructorName.accept(this),
      instanceCreationExpression_typeArguments: nodeImpl.typeArguments?.accept(this),
      expression_type: _writeType(node.staticType),
    );
    builder.flags = AstBinaryFlags.encode(
  ...
  LinkedNodeBuilder visitInterpolationExpression(InterpolationExpression node) {
    return LinkedNodeBuilder.interpolationExpression(
      interpolationExpression_expression: node.expression.accept(this),
        ...
        isStringInterpolationIdentifier: node.leftBracket.type == TokenType.STRING_INTERPOLATION_IDENTIFIER,
      );
  }
  ...
  LinkedNodeBuilder visitOnClause(OnClause node) {
    return LinkedNodeBuilder.onClause(
      onClause_superclassConstraints: _writeNodeList(node.superclassConstraints),
    );
  }
  ...
  @override
  LinkedNodeBuilder visitRedirectingConstructorInvocation(RedirectingConstructorInvocation node) {
    var elementComponents = _componentsOfElement(node.staticElement);
    var builder = LinkedNodeBuilder.redirectingConstructorInvocation(
      redirectingConstructorInvocation_arguments: node.argumentList.accept(this),
      redirectingConstructorInvocation_constructorName: node.constructorName?.accept(this),
      redirectingConstructorInvocation_element: elementComponents.rawElement,
      redirectingConstructorInvocation_substitution: elementComponents.substitution,
    );
    builder.flags = AstBinaryFlags.encode(
      hasThis: node.thisKeyword != null,
    );
  ...
  @override
  LinkedNodeBuilder visitSuperConstructorInvocation(SuperConstructorInvocation node) {
    var elementComponents = _componentsOfElement(node.staticElement);
    var builder = LinkedNodeBuilder.superConstructorInvocation(
      ...
      superConstructorInvocation_constructorName: node.constructorName?.accept(this),
  ...
  @override
  LinkedNodeBuilder visitTopLevelVariableDeclaration(TopLevelVariableDeclaration node) {
  ...
  LinkedNodeBuilder visitVariableDeclaration(VariableDeclaration node) {
    ...
    if (declaration is TopLevelVariableDeclaration) {
      ...
      if (!(declarationList.isConst || !declaration.isStatic && declarationList.isFinal && _hasConstConstructor)) {
        initializer = null;
      }
    }
  ...
  @override
  LinkedNodeBuilder visitVariableDeclarationStatement(VariableDeclarationStatement node) {
  ...
  void _storeClassOrMixinDeclaration(LinkedNodeBuilder builder, ClassOrMixinDeclaration node) {
    builder
      ..classOrMixinDeclaration_implementsClause = node.implementsClause?.accept(this)
      ..classOrMixinDeclaration_members = _writeNodeList(node.members)
      ..classOrMixinDeclaration_typeParameters = node.typeParameters?.accept(this);
    _storeNamedCompilationUnitMember(builder, node);
    _storeIsSimpleBounded(builder, node);
  }

  void _storeCompilationUnitMember(LinkedNodeBuilder builder, CompilationUnitMember node) {
    _storeDeclaration(builder, node);
  }

  void _storeConstructorInitializer(LinkedNodeBuilder builder, ConstructorInitializer node) {}
  ...
  void _storeInvocationExpression(LinkedNodeBuilder builder, InvocationExpression node) {
    _storeExpression(builder, node);
    builder
  ...
  void _storeNamedCompilationUnitMember(LinkedNodeBuilder builder, NamedCompilationUnitMember node) {
    _storeCompilationUnitMember(builder, node);
    _storeInformativeId(builder, node);
    builder.name = node.name.name;
  }

  void _storeNamespaceDirective(LinkedNodeBuilder builder, NamespaceDirective node) {
    _storeUriBasedDirective(builder, node);
    builder
  ...
  void _storeNormalFormalParameter(LinkedNodeBuilder builder, NormalFormalParameter node, Token keyword) {
  ...
  void _storeTypedLiteral(LinkedNodeBuilder builder, TypedLiteral node, {bool isMap = false, bool isSet = false}) {
    _storeExpression(builder, node);
    builder
      ..flags = AstBinaryFlags.encode(
        hasTypeArguments: node.typeArguments != null,
  ...
  void _storeUriBasedDirective(LinkedNodeBuilder builder, UriBasedDirective node) {
    _storeDirective(builder, node);
    builder
