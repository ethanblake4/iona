...
class _TextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _TextFieldSelectionGestureDetectorBuilder({
    @required _FitTextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _FitTextFieldState _state;
...
///
/// To integrate the [FitTextField] into a [Form] with other [FormField] widgets,
...
///
/// {@tool snippet}
/// This example shows how to create a [FitTextField] that will obscure input. The
...
class FitTextField extends StatefulWidget {
  ...
  /// [FitTextField.noMaxLength] then only the current length is displayed.
  ///
  ...
  const FitTextField({
    ...
    this.autofillHints,
        ...
        assert(maxLength == null || maxLength == FitTextField.noMaxLength || maxLength > 0),
  ...
  /// to [FitTextField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforced] is set to false. The text field
  /// enforces the length with a [LengthLimitingTextInputFormatter], which is
  ...
  ///
  /// This value must be either null, [FitTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [FitTextField.noMaxLength], then no limit will
  ...
  ///
  /// The [mouseCursor] is the only property of [FitTextField] that controls the
  ...
  @override
  _FitTextFieldState createState() => _FitTextFieldState();
...
class _FitTextFieldState extends State<FitTextField> implements TextSelectionGestureDetectorBuilderDelegate {
  TextEditingController _controller;
  ...
  @override
  void didUpdateWidget(FitTextField oldWidget) {
