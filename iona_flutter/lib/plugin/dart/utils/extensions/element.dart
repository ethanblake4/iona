...
extension ClassElementExtensions on ClassElement {
  ...
  /// `dart:core`.
  bool get isDartCoreIterable => this != null && name == 'Iterable' && library.isDartCore;

  /// Return `true` if this element represents the class `List` from
  /// `dart:core`.
  bool get isDartCoreList => this != null && name == 'List' && library.isDartCore;
...
extension ElementExtension on Element {
  ...
  bool get hasOrInheritsDeprecated {
    ...
    return ancestor is CompilationUnitElement && ancestor.enclosingElement.hasDeprecated;
  }
}
