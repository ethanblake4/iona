...
class DirtyList<E> extends DelegatingIterable<E> implements List<E> {
  ...
  @override
  List<R> cast<R>() => new DirtyList._(_listBase.cast());

  @override
  List<E> operator +(List<E> other) {
    return DirtyList._(_listBase + other);
  }

  @override
  set first(E value) {
    _listBase.first = value;
    _dirty = true;
  }

  @override
  int indexWhere(bool Function(E element) test, [int start = 0]) {
    return _listBase.indexWhere(test, start);
  }
  ...
  int lastIndexWhere(bool Function(E element) test, [int start]) {
    return _listBase.lastIndexWhere(test, start);
  }
}
